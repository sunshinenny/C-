...
int main()
{
	...
	void Input(int n);void Output(int n);void Find(int n);
...
void Input(int n)
{
	int i,number[100],score[100],n1,n2,n3,n4,n5;
	char name[100][20];
	for(i=0;i<n;i++)
    {
	    printf("请输入第%d个学生信息：\n",i+1);
...
void Find(int n)
{
	int i,number[100],score[100],flag=1;
	char name[100][20],NAME[100];
